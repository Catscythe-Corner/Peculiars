...
public class PeculiarsItems {
    ...
    public static final RegistryObject<Item> YUCCA_ICE_CREAM = HELPER.createItem("yucca_ice_cream", () -> new IceCreamItem(new Item.Properties().food(Foods.YUCCA_ICE_CREAM).craftRemainder(Items.BOWL).stacksTo(1).tab(CreativeModeTab.TAB_FOOD)));
    public static final RegistryObject<Item> YUCCA_MILKSHAKE = HELPER.createItem("yucca_milkshake", () -> new MilkshakeItem(new Item.Properties().food(Foods.YUCCA_MILKSHAKE).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(CreativeModeTab.TAB_FOOD)));
    ...
    public static final RegistryObject<Item> ALOE_ICE_CREAM = HELPER.createItem("aloe_ice_cream", () -> new IceCreamItem(new Item.Properties().food(Foods.ALOE_ICE_CREAM).craftRemainder(Items.BOWL).stacksTo(1).tab(CreativeModeTab.TAB_FOOD)));
    public static final RegistryObject<Item> ALOE_MILKSHAKE = HELPER.createItem("aloe_milkshake", () -> new MilkshakeItem(new Item.Properties().food(Foods.ALOE_MILKSHAKE).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(CreativeModeTab.TAB_FOOD)));
    ...
    public static final RegistryObject<Item> PASSIONFRUIT_ICE_CREAM = HELPER.createItem("passionfruit_ice_cream", () -> new IceCreamItem(new Item.Properties().food(Foods.PASSIONFRUIT_ICE_CREAM).craftRemainder(Items.BOWL).stacksTo(1).tab(CreativeModeTab.TAB_FOOD)));
    public static final RegistryObject<Item> PASSIONFRUIT_MILKSHAKE = HELPER.createItem("passionfruit_milkshake", () -> new MilkshakeItem(new Item.Properties().food(Foods.PASSIONFRUIT_MILKSHAKE).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(CreativeModeTab.TAB_FOOD)));
